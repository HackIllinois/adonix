...
describe("Project Router", () => {
    ...
    describe("GET /project/:ownerId/", () => {
        it("should give a forbidden error for a non-staff user", async () => {
            const response = await getAsAttendee(`/project/${TESTER.id}/`).expect(StatusCode.ClientErrorForbidden);
        ...
        it("should give a not found error if the project does not exist (staff user)", async () => {
            ...
            const response = await getAsStaff(`/project/${TESTER.id}/`).expect(StatusCode.ClientErrorNotFound);
        ...
        it("should return project details for a staff user", async () => {
            ...
            const response = await getAsStaff(`/project/${TESTER.id}/`).expect(StatusCode.SuccessOK);
