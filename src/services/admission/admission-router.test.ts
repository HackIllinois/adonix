...
import { Gender, Degree, Race, HackInterest, HackOutreach, RegistrationApplicationDraft } from "../registration/registration-schemas";
...
beforeEach(async () => {
    ...
    await Models.RegistrationApplicationDraft.create(TESTER_APPLICATION);
});
